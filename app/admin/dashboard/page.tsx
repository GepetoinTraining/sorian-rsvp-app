...
// 1. Define the exact type returned by the query
...
// 2. Explicitly type the return Promise
      ...
      <Container size="lg" py="xl">
            ...
            <Card withBorder radius="md" p="md">
              <Group>
                ...
                <div>
                  ...
                  <Text fw={700} size="xl">
                    {/* 3. Explicitly type the reduce parameters */}
                    {events.reduce((acc: number, curr: EventWithRsvpCount) => acc + curr._count.rsvps, 0)}
                  </Text>
                </div>
              </Group>
            </Card>
        ...
        {events.length === 0 ? (
          ...
          <SimpleGrid cols={{ base: 1, md: 2 }} spacing="lg">
            {/* 4. Explicitly type the map parameter */}
            {events.map((event: EventWithRsvpCount) => (
